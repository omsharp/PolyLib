...
namespace Tests.SingleVariable
{
   public class SubtractPolynomial
   {
      ...
      public void SubtractPolynomia_WithNewDegrees()
      {
         ...
         Assert.Equal(co4, p3[4].Coefficient);
         Assert.Equal(co3, p3[3].Coefficient);
         Assert.Equal(co2, p3[2].Coefficient);
         Assert.Equal(-co1, p3[1].Coefficient);
         Assert.Equal(-co0, p3[0].Coefficient);
      }
      ...
      public void SubtractPolynomial_WithIntersectedDegrees()
      {
         ...
         Assert.Equal(p1co4 - p2co4, p3[4].Coefficient);
         Assert.Equal(p1co2 - p2co2, p3[2].Coefficient);
      }
   }
}